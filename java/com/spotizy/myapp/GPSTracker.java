...
public class GPSTracker extends Service implements LocationListener {
    ...
    private static final long MIN_DISTANCE_CHANGE_FOR_UPDATES = 10000; // 10 kms
    ...
    public Location getLocation() {
        try {
            ...
            System.out.println("####  GPSTracker isGPSEnabled "+isGPSEnabled+" isNetworkEnabled "+isNetworkEnabled);
            if (!isGPSEnabled && !isNetworkEnabled) {
                    ...
                    if ((ContextCompat.checkSelfPermission( this.mContext, android.Manifest.permission.ACCESS_FINE_LOCATION ) != PackageManager.PERMISSION_GRANTED) &&
                        ...
                        if (locationManager != null) {
                            ...
                            if (location != null) {
                                ...
                                System.out.println("####  GPSTracker isGPSEnabled"+latitude+" longitude "+longitude);
                            }
                        }
                    }
                }
                ...
                if (isGPSEnabled) {
                    ...
                    System.out.println("### Locationmanager "+ContextCompat.checkSelfPermission( this.mContext, android.Manifest.permission.ACCESS_FINE_LOCATION )+ " "+
                    ...
                    if ((ContextCompat.checkSelfPermission( this.mContext, android.Manifest.permission.ACCESS_FINE_LOCATION ) != PackageManager.PERMISSION_GRANTED) &&
                        ...
                        System.out.println("#### Location Manager permission");
                        if (location == null) {
    ...
    public double getLatitude(){
        ...
        System.out.println("##### GetLatitude 2");
        // return latitude
        return latitude;
    }
    ...
    public void onLocationChanged(Location location) {
        System.out.println("####  GPSTracker onLocationChanged");
                getLatitude();
        getLongitude();
    }
